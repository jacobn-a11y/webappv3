/**
 * Publish modal for landing pages.
 *
 * Extracted from LandingPageEditorPage to isolate publish-related
 * state and reduce the editor page's complexity.
 */
...
export function PublishModal({
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      if (modalRef.current) {
        trapDialogFocus(e, modalRef.current, onClose);
      }
    };
