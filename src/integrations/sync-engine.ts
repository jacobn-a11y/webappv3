...
import { syncCRMProvider as syncCRMProviderImpl } from "./sync-engine-crm.js";
...
export class SyncEngine {
  ...
  private async syncCRMProvider(
    ...
    return syncCRMProviderImpl(
      {
        prisma: this.prisma,
        withRetry: this.withRetry.bind(this),
        queueMergeConflictReview: this.queueMergeConflictReview.bind(this),
      },
      config,
      provider,
      credentials
