...
import { sendSuccess, sendCreated, sendNotFound, sendError } from "../_shared/responses.js";
  ...
  router.put(
    ...
    asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
      ...
      if (duplicateOrders.size > 0) {
        sendError(res, 400, "validation_error", "Each approval step_order must be unique.");
        return;
      }
