 ...
 *
 * GET /dashboard — Server-rendered HTML analytics dashboard with Chart.js
 */
...
interface RegisterDashboardRendererOptions {
  router: Router;
  analytics: AnalyticsService;
  analyticsCache: ResponseCache<AnalyticsDashboardData>;
}

export function registerDashboardRenderer({
  router,
  analytics,
  analyticsCache,
}: RegisterDashboardRendererOptions): void {
  /**
